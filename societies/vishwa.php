...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Vishwakarma Society</a></h1>
    </div>
  ...
  <!-- ======= Hero Section ======= --> 
    ...
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to Vishwakarma Society</h1> 
     </div>
  </section>   
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-7" data-aos="fade-right">
            <img src="images/ma.jpg" alt=""width="500" height="500">
          </div>
          <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <h3 data-aos="fade-up">About Vishwakarma</h3>
            ...
            <div class="wrapper">
              <div class="row">
                ...
                <div class="col-lg-4">
                 ...
                 <div class="col-lg-4">
                  <div class="counter">
                    <p><h3>15</h3> Total Flats Available<br></p>
                  </div>
                </div>
              </div>
              </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Services</h2>
          <p>Vishwakarma Society provides services like Registration, Notice board, also Rent and Sells advertisement, Compalint box to society members.</p>
        </div>
 ...
 <section id="Advertisement" class="portfolio section-bg">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Advertisement</h2>
      <p>Vishwakarma society shows the flats which are for rent and  also for the sell </p>
    </div>
        ...
        <div class="portfolio-wrap">
          ...
          <h4>Flat No:<?php echo $row['flat_no'];?></h4> 
            ...
            <div class="portfolio-links">
              <a href="images/c.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-plus"></i></a>             
            </div>
          </div>
        </div>
      </div>
