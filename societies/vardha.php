...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Vardha Society</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="images/log.jpg" alt="" class="img-fluid"></a>  -->
      </div>
  ...
  <!-- ======= Hero Section ======= --> 
    ...
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to Vardha Society</h1> 
     </div>
  </section>   
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-7" data-aos="fade-right">
            <img src="images/b.jpg" alt=""width="500" height="500">
          </div>
          <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <h3 data-aos="fade-up">About Vardha</h3>
          ...
          <div class="fun-facts">
            <div class="wrapper">
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="counter">
                    <p> <h3>30</h3> Total Parkings<br></p>
                  </div>
                </div>
                 <div class="col-lg-4">
                  <div class="counter">
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Services</h2>
          <p>Vardha Society provides services like Registration, Notice board, also Rent and Sells advertisement, Compalint box to society members</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up"
            ...
            <div class="icon-box icon-box-cyan">
              ...
              <p class="description">The secretary of perticular society adds notices to display their society members
              </p>
 ...
 <section id="Advertisement" class="portfolio section-bg">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Advertisement</h2>
      <p>Vardha society shows the flats which are for rent and  also for the sell</p>
    </div>
        ...
        <div class="portfolio-wrap">
          ...
          <h4>Flat No:<?php echo $row['flat_no'];?></h4> 
            ...
            <div class="portfolio-links">
              <a href="images/home.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Tarabai Park, Kolhapur</p>
              </div>

              <div class="email mt-4">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>vardha@gmail.com</p>
              </div>
