...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="rishbh.php">Rishbh Sidhhi Society</a></h1>
  ...
  <!-- ======= Hero Section ======= -->
    ...
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to Rishbh Siddhi Society</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-7" data-aos="fade-right">
            <img src="images/rishbh.jpeg" class="img-fluid" alt="">
          </div>
          <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <h3 data-aos="fade-up">About Rishbh Siddhi</h3>
            <p data-aos="fade-up">
              We provide user-friendly and feature-rich web portal for housing society resident members to simplify
              ...
              members to simplify.<br>
              <div class="fun-facts">
                <div class="wrapper">
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="counter">  
                         <p><h3>1/2 BHK</h3> Flat Space </p>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="counter">                        
                     ...
                     <div class="col-lg-4">
                      <div class="counter">                      
                        <p><h3>8</h3>Total Flats Available<br></p>
                      </div>
                    </div>
                  </div>
                  </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Services</h2>
          <p>Rishbh Siddhi provides services like Registration, Notice board, also Rent and Sells advertisement, Compalint box to society members.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up"
            ...
            <div class="icon-box icon-box-green">
              ...
              <p class="description">The secretary of perticular society can post Rent & Sales adverticements</p>
...
<!-- Advertise -->
 <section id="Advertisement" class="portfolio section-bg">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Advertisement</h2>
      <p> Rishbh Siddhi shows the flats which are for rent and  also for the sell.</p>
    </div>
    ...
    while($row = $result->fetch_array())
      ...
      <div class="col-lg-4 col-md-6 portfolio-item <?PHP echo $sell_rent; ?>" >
        <div class="portfolio-wrap">
          <img src="uploads/<?php echo $row['image_url'];?>" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Flat No:<?php echo $row['flat_no'];?></h4> 
            <p>Area:<?php echo $row['area'];?></p>
            <div class="portfolio-links">
            <a href="uploads/<?php echo $row['image_url'];?>" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Nagala Park, Kolhapur</p>
              </div>

              <div class="email mt-4">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>rishbh@gmail.com</p>
              </div>
