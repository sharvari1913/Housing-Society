...
<?php 
    if(isset($_POST['submit']))
    {
        ...
        // {
            ...
            $sql= "UPDATE `user_mst` SET `full_name`='$fullname',`email`='$email', `flat_no`='$flatno', `mobile_no`='$mobileno', `age`='$age', `gender`='$gender', `group_level`='$grouplevel', `area`='$area', `rent`='$rent', `sell`='$sell' WHERE `user_id`='".$user_id."' ";
            //echo $sql;
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="validationCustom02" class="form-label">Flat On Rent
                                                    </label><br>
                                                    &nbsp<input type="radio" name="rent" value="1"
                                                        <?php $gid =$row['rent']; if($gid==1){ echo ("checked");} ?>>&nbsp
                                                    Yes
                                                    &nbsp &nbsp <input type="radio" name="rent" value="0"
                                                        <?php $gid =$row['rent']; if($gid==2){echo ("checked");} ?>>&nbsp
                                                    No
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="validationCustom02" class="form-label">Flat On Sell
                                                    </label><br>
                                                    &nbsp<input type="radio" name="sell" value="1"
                                                        <?php $gid =$row['sell']; if($gid==1){ echo ("checked");} ?>>&nbsp
                                                    Yes
                                                    &nbsp &nbsp <input type="radio" name="sell" value="0"
                                                        <?php $gid =$row['sell']; if($gid==2){echo ("checked");} ?>>&nbsp
                                                    No
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom01"
                                                        name="area" value="<?php echo $row['area'];?>"
                                                        style="text-transform: capitalize;">
                                                </div>
                                            </div>
                                        </div>
