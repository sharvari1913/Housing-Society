            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group pt-2 text-right ">
                        <a href="add-notice.php" class="btn btn-primary btn-lg abled" role="button"
                            aria-disabled="true">Add Notice</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered" style="background-color:white;" id="example">
                        ...
                        <tbody>
                            <?php
                                    ...
                                    $query = "select *, soc_name FROM notice INNER JOIN society on society.soc_id = notice.soc_id";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="edit_society"
                                        href="update-notice.php?id=<?php echo $row['notice_id']. '"'; ?>	<span class="
                                        fa fa-pencil"></span></a>

                                    <a id="edit_society"
                                        href="delete-notice.php?id=<?php echo $row['notice_id']. '"'; ?>	<span class="
                                        fa fa-trash"></span></a>
                                </td>
