                    ...
                    <table class="table table-bordered" style="background-color:white;" id="example">
                        ...
                        <tbody>
                            <?php
                                    ...
                                    $query = "select *, soc_name FROM complaint INNER JOIN society on society.soc_id = complaint.soc_id";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="edit_society"
                                        href="update-complaint.php?id=<?php echo $row['comp_id']. '"'; ?>	<span class="
                                        fa fa-pencil"></span></a>
