            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group pt-2 text-right ">
                        <a href="add-maintenance.php" class="btn btn-primary btn-lg abled" role="button"
                    ...
                    <table class="table table-bordered" style="background-color:white;" id="example">
                        ...
                        <tbody>
                            <?php
                                    ...
                                    $query = "select *, soc_name FROM maintenance INNER JOIN society on society.soc_id = maintenance.soc_id";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="edit_society"
                                        href="update-maintenance.php?id=<?php echo $row['main_id']. '"'; ?>	<span class="
                                        fa fa-pencil"></span></a>
