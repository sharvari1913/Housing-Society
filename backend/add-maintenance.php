...
<?php 
        ...
        $sql="INSERT INTO `maintenance`(`soc_id`, `main_type`, `main_date`, `pay_mode`, `pay_date`) VALUES ('$societyid', '$maintype', '$maindate', '$paymode', '$paydate')";  //echo $sql;
        $result=mysqli_query($con,$sql);
        if($result)
        {
            echo $sql;
            echo "<script>alert('Record Inserted');window.location.href='view-maintenance.php';</script>";
