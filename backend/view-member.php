...
<?php 
    if(isset($_POST['submit']))
    {
        ...
        // {
            ...
            $sql= "UPDATE `user_mst` SET `full_name`='$fullname',`email`='$email',`soc_id`='$societyid', `flat_no`='$flatno', `mobile_no`='$mobileno', `age`='$age', `gender`='$gender', `group_level`='$grouplevel', `username`='$username', `password`='$password' WHERE `user_id`='".$user_id."' ";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group pt-2 text-right ">
                        <a href="add-member.php" class="btn btn-primary btn-lg abled" role="button"
                    ...
                    <table class="table table-bordered" style="background-color:white;" id="example">
                        ...
                        <tbody>
                            <?php
                                    ...
                                    $query = "select *, soc_name FROM user_mst INNER JOIN society on society.soc_id = user_mst.soc_id";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="edit_society"
                                        href="update-member.php?id=<?php echo $row['user_id']. '"'; ?>	<span class=" fa
                                        fa-pencil"></span></a>
