                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    &nbsp &nbsp <input type="radio" name="grouplevel" value="9"
                                                        <?php $gid =$row['group_level']; if($gid==9){echo ("checked");} ?>>&nbsp
                                                    Admin
                                                    &nbsp<input type="radio" name="grouplevel" value="1"
                                                        <?php $gid =$row['group_level']; if($gid==1){ echo ("checked");} ?>>&nbsp
                                                    Secretary
